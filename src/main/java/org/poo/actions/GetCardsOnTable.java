...
public final class GetCardsOnTable {
     ...
     * - "output": an ArrayNode where each row of the table is represented as an array of cards,
     * with each card including its mana, attack damage, health, description, colors, and name.
     */
